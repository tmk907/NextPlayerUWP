...
namespace NextPlayerUWPDataLayer.Images.PaletteUWP
{
    ...
    public class ColorCutQuantizer
    {
        ...
        private List<Palette.Swatch> QuantizePixels(int maxColors)
        {
            ...
            pq.Add(new Vbox(0, mColors.Length - 1, mColors, mHistogram));
        ...
        private List<Palette.Swatch> GenerateAverageColors(IEnumerable<Vbox> vboxes)
        {
        ...
        private class Vbox
        {
            ...
            private int[] vmColors;
            private int[] vmHistogram;
            ...
            public Vbox SplitBox()
            {
                ...
                Vbox newBox = new Vbox(splitPoint + 1, mUpperIndex, vmColors, vmHistogram);
